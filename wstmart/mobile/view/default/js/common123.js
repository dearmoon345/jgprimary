...
//搜索
WST.search = function(type,obj=false){
	if(obj != false){
		var data = $(obj).html();
	}else{
	...
	if(type==1){
		...
		location.href = WST.U('mobile/shops/home','goodsName='+data+'&shopId='+shopId,true);//店铺商品
	}
};
//关注
...
WST.upload = function(opts){
  var _opts = {};
  _opts = $.extend(_opts,{auto: true,swf: WST.conf.ROOT +'/plugins/webuploader/Uploader.swf',server:WST.U('mobile/orders/uploadPic')},opts);
