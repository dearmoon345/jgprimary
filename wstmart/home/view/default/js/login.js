...
function login(typ){
    ...
    // if(params.loginName==""&& params.loginPwd=="" && params.loginName1 == ""){
    //     WST.msg("请输入用户名或密码", {icon: 5});
    //     return false;
    // }else if(params.loginName=="" && params.loginName1 == ""){
...
function login1(typ){
    ...
    // if(!$('#verifyCode').isValid())return;
    if(params.loginName1 == "" && params.mobileCode == ""){
        WST.msg("请输入用户名或短信验证码", {icon: 5});
        return false;
    }else if(params.loginName1 == ""){
        WST.msg("请输入用户名", {icon: 5});
        return false;
    }else if(params.loginPwd==""){
