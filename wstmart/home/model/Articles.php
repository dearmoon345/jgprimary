...
class Articles extends Base{
	...
	*/
	public function getNewsById(){
		$id = (int)input('id');
		return $this->alias('a')->join('__ARTICLE_CATS__ ac','a.catId=ac.catId','inner')->where('a.catId<>7 and ac.parentId<>7 and a.dataFlag=1 and a.isShow=1')->cache(true)->find($id);
	}
